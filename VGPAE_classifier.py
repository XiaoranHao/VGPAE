...
class VGPAE_v2(BaseVAE):
    ...
    def __init__(self,
        ...
        output_init = init_para[1] + torch.randn(latent_dim2) * 0.01
        length_init = init_para[2] + torch.randn(latent_dim1) * 0.01
...
class VGPAE_v3(VGPAE_v2):
    def __init__(self, *args, **kwargs):
        super(VGPAE_v3, self).__init__(*args, **kwargs)
        self.decoder_input = nn.Linear(self.latent_dim2 + self.latent_dim1, self.last_h_dim * self.last_layer_size)
